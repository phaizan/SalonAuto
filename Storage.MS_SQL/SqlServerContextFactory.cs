...
namespace Storage.MS_SQL
{
    ...
    {
        private const string DbContextString = "Server=localhost,1433;Database=Example;User ID=sa;Password=pR0$touzhedaitemnepultOtyanderki;MultipleActiveResultSets=true;TrustServerCertificate=True";
